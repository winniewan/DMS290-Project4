    ...
    <div class="card my-5 mx-5 p-4">
      <div class="container-fluid px-4">
        ...
        <section>
          ...
          <p>
            GSDs became popular in the United States in the early 1900s, thanks in part to the adventures of canine movie stars
            Rin-Tin-Tin and Strongheart. The GSD is among those German breeds, the Dachshund is another, that suffered from anti-German
            sentiment during and after the world wars. In World War I–era Britain, the breed was referred to as the Alsatian, a name
            many British dog lovers still prefer. With the rise of modern livestock management and the decline of herding as a canine
            occupation, von Stephanitz shrewdly promoted his breed as an ideal K-9 worker. The GSD is today the preferred dog for
            police and military units the world over.
          </p>
        </section>
